...
HRESULT InitPause(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/pause003.png", &g_pTexturePause[4]);
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/pause002.png", &g_pTexturePause[5]);
...
void UpdatePause(void)
{
	...
	case PAUSE_MENU_CONTINUE:
		...
		g_aPause[5].col = D3DXCOLOR(0.75f, 0.75f, 0.75f, 1.0f);
	...
	case PAUSE_MENU_QUIT:
		...
		g_aPause[5].col = D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f);
	...
	if (GetKeyboardTrigger(DIK_RETURN) == true)
	{
		...
		if (g_State == PAUSE_MENU_STAGESELECT)
		{
...
void SetVertexPause(int nIdx)
{
	...
	{
		g_aPause[nIdx].pos = D3DXVECTOR3(960.0f, 350.0f, 0.0f);
		//頂点の座標
	...
	{
		g_aPause[nIdx].pos = D3DXVECTOR3(960.0f, 116.0f + (nIdx * 116), 0.0f);
		//頂点の座標
		pVtx[0].pos = D3DXVECTOR3(g_aPause[nIdx].pos.x - CONTINUE_SIZE_X, g_aPause[nIdx].pos.y + CONTINUE_SIZE_Y, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_aPause[nIdx].pos.x - CONTINUE_SIZE_X, g_aPause[nIdx].pos.y - CONTINUE_SIZE_Y, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_aPause[nIdx].pos.x + CONTINUE_SIZE_X, g_aPause[nIdx].pos.y + CONTINUE_SIZE_Y, 0.0f);
